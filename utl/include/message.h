...
void utl_Message_setInt32(const utl_Message* message, const utl_FieldDef* field, int32_t value);
void utl_Message_setInt64(const utl_Message* message, const utl_FieldDef* field, int64_t value);
void utl_Message_setInt128(const utl_Message* message, const utl_FieldDef* field, utl_Int128 value);
